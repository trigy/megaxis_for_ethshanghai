...
import {formatPrice, generateLikes, transType} from "../../../../utils/tools";
...
const PromptDetail = () => {
    ...
    function handleToMarket() {
        window.open("http://52.199.77.200:3000");
    }
                        ...
                        <div className="detail-card">
                            ...
                            <div className="likes-slot">
                                    ...
                                    <div className="likes-square">
                                        ...
                                        <div className="likes-font">{generateLikes()}</div>
                                    </div>


                                <div className="likes-square">
                                    <MsgLine className="icon1"/>
                                    <span className="likes-font">0</span>
                                </div>
                                <div className="likes-square">
                                    <TbUPLine className="icon1"/>
                                    <span className="likes-font">{pInfo.likes}</span>
