...
const PlusGPT = (props) => {
    ...
    const handleSubmit = async () => {
        ...
        await askGPT({ data: askData }).then(res => {
            const newChatData = [
                ...chatData,
                ...
                <div className="lower">
                    ...
                    <div className='chat-left'>
                        ...
                        <div className="box" style={{ height: "100%" }}>
                            ...
                            <div className="box-content">
                                ...
                                <div className="pagination" style={{ position: 'sticky', bottom: 2 }}>
                                    <Pagination
                                        simple='simple'
                                        pageSize={pageInfo[1]}
                                        total={56000}
                                        onChange={(page) => { handleChangePage(page, pageInfo[1]); getGeneralPrompt() }}
                                    />
                                </div>
                    ...
                    <div className="chat-container">
                        ...
                        <div className="input-container">
                            ...
                            ) : <FaPaperPlane className="send-button" onClick={handleSubmit} disabled={isLoading} />}
