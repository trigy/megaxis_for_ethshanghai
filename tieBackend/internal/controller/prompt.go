...
func (c *cPrompt) GetAuthLevel(ctx context.Context, req *v1.GetAuthLevelReq) (res *v1.GetAuthLevelRes, err error) {
	res = &v1.GetAuthLevelRes{}
	res.Level = service.Prompt().GetAuthLevel(ctx, req.Uid, req.Pid)
	return
}

func (c *cPrompt) GetAllPrompt(ctx context.Context, req *v1.GetAllPromptReq) (res *v1.GetAllPromptRes, err error) {
	res, err = service.Prompt().GetAllPrompt(ctx, req)
	return
}
