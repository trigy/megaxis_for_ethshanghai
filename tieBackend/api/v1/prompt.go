...
type GetAuthLevelReq struct {
	g.Meta `path:"/prompt/authlevel" method:"post" tags:"PromptService" summary:"Get "`
	Uid    string `json:"uid" v:"required"`
	Pid    string `json:"pid" v:"required"`
}

type GetAuthLevelRes struct {
	Level int `json:"level"`
}

type GetAllPromptReq struct {
	g.Meta `path:"/prompt/getAll" method:"post" tags:"PromptService" summary:"Get All Prompt"`
	Offset int `json:"offset" v:"required"`
	Limit  int `json:"limit" v:"required"`
}

type GetAllPromptRes struct {
	PromptInfos
	Total int `json:"total"`
}
